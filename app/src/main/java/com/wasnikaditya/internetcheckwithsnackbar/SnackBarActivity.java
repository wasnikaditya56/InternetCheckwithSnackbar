      ...
      //  setSupportActionBar(toolbar);
        ...
        findViewById(R.id.button_default).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Snacky.builder().setActivity(SnackBarActivity.this).setActionText("ACTION").setActionClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                //do something
                            }
        ...
        findViewById(R.id.button_success).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Snacky.builder()
                        .setActivity(SnackBarActivity.this)
                        .setText("Success")
                        .setDuration(Snacky.LENGTH_SHORT)
                        .success()
                        .show();
